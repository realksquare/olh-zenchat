        ...
        <div className="voice-message-bubble">
            ...
            >
                {audioError ? (
                    ...
                    <div className="loader-sm" style={{ width: '14px', height: '14px', border: '2px solid var(--color-border, rgba(255, 255, 255, 0.08))', borderTopColor: 'var(--color-primary)', borderRadius: '50%', animation: 'aura-spin 1.8s linear infinite' }} />
                ) : isPlaying ? (
