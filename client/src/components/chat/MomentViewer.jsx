                        ...
                        <div className="aura-viewer-actions">
                            {isOwn && (
                                <div className="aura-view-counter" title="Views">
                                    ...
                                    <span style={{ fontSize: '1rem', fontWeight: '700' }}>{getViewCount(currentMoment._id, currentMoment.userId)}</span>
                                </div>
                            )}
                            {isOwn && (
                                <button className="aura-trash-btn" onClick={(e) => { e.stopPropagation(); setShowDeleteConfirm(true); }} title="Let go.">
