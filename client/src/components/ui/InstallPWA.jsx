...
const InstallPWA = () => {
    ...
    if (!showModal && !showNudgeModal) return null;
                    ...
                    <div style={{ padding: '0 28px 28px', textAlign: 'center' }}>
                        ...
                        <div style={{ display: "flex", gap: "1rem" }}>
                            ...
                            <button
                                onClick={() => {
                                    handleDismissNudge();
                                    alert("To open the PWA, please click your browser's options menu (e.g. three dots in Chrome) and select 'Open in ZenChat', or launch ZenChat from your home screen / application launcher!");
                                }}
