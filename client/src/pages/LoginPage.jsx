    ...
    if (mfaRequired) {
        return (
            <div className="auth-page">
                <div className="auth-card" style={{ maxWidth: "440px", border: "1px solid var(--color-border, rgba(255, 255, 255, 0.08))", background: "rgba(15, 23, 42, 0.75)", backdropFilter: "blur(20px)" }}>
